...
Social Media GraphQL is a modern social media platform showcasing full-stack development with Next.js, GraphQL, and MongoDB.

It allows users to create posts, engage through likes and comments, all powered by a type-safe GraphQL API built with TypeScript.
...
|----------------|--------------|
| ![Desktop 1](./public/Screenshot%201.jpg) | ![Mobile 1](./public/Screenshot%20Mobile%201.jpg) |
...
### 🎬 Video
> [![Watch the demo](https://img.youtube.com/vi/CT2_3T8Q_x4/maxresdefault.jpg)](https://youtu.be/CT2_3T8Q_x4 "Watch the demo on YouTube")
...
- https://social-media-graphql.vercel.app
...
$ git clone https://github.com/eduardocodes/social-media-graphql.git
